class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        my.sprite.player = this.physics.add.sprite(this.spawnpoint[0].x, this.spawnpoint[0].y, "platformer_characters", "tile_0000.png");
        ...
        this.physics.add.overlap(my.sprite.player, this.jumpmenGroup, (obj1, obj2) => {
            obj2.destroy(); // remove jumpman on overlap
            my.sprite.player.body.setVelocityY(this.JUMP_VELOCITY * 1.5); // extra jump boost
        });
